...
function InjuryQuestionnaireForm({ selectedPatient }) {
  ...
  // We'll rename some fields in the UI for clarity:
  //   aggravating_factors -> what_makes_it_worse
  //   easing_factors -> what_makes_it_better
  // But we still store them in the same structure or pass them as needed.
  ...
  // Handle toggles for specialized tests
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: "0.9rem", color: "#666" }}>
        Please fill out the questions below to help us (and our AI) understand your current
        injury. Don't worry if you're unsure about any tests or technical details—just fill 
        in what you can!
      </p>
      ...
      {selectedPatient ? (
        <form onSubmit={handleSubmit} style={{ marginTop: "1rem" }}>
          ...
          {/* Easing factors -> what_makes_it_better */}
          <div style={{ marginBottom: "1rem" }}>
            <label style={{ display: "block", fontWeight: "bold" }}>
          ...
          {/* Example: You could conditionally render "Knee" or "Hip" tests similarly */}
          {/* if (formData.body_part === "Knee") { ... } */}
      ...
      {diagnosisResult && (
        <div style={{ 
          ...
          <h4 style={{ color: "#ff4646", marginBottom: "1rem" }}>AI Analysis Results</h4>
